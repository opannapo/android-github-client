...
public class RepoAdapter extends BaseRecyclerViewAdapter {
    private static final int VIEW_TYPE_DEFAULT = 1;

    public RepoAdapter(Context context, ArrayList<?> dataModels, Object headerObject, Object footerObject) {
    ...
    public RecyclerView.ViewHolder createItemsViewHolder(ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_DEFAULT) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.vh_repos, parent, false);
