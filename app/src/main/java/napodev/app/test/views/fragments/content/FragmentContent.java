...
public class FragmentContent extends BaseFragment implements FragmentContentView.ViewImpl {
    FragmentContentView view;
    FragmentContentWorker worker;
    ...
    public void onViewCreatedBase(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = new FragmentContentView(this, this, worker, inflater, container);
        worker = new FragmentContentWorker(this);
    ...
    @Override
    public void resRepoContent(boolean y, String info, ArrayList<ContentEntity> entities) {
