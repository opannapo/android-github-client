...
public class FragmentFollowers extends BaseFragment implements FragmentFollowersView.ViewImpl {
    private FragmentFollowersView view;
    private FragmentFollowersWorker worker;
    ...
    public void onViewCreatedBase(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = new FragmentFollowersView(this, this, worker, inflater, container);
        worker = new FragmentFollowersWorker(this);
    ...
    public void onHiddenChangedBase(boolean isHidden) {
        if (!isHidden && isFirstVisible()) {
            ...
            worker.reqUserFollowers(userEntity.getLogin());
        }
    }
    ...
    @Override
    public void resUserFollowers(boolean y, String info, ArrayList<UserEntity> entities) {
