...
public class FragmentFollowersView extends BaseFragmentViewModel {
    @Child(R.id.rV) RecyclerView rV;

    public interface ViewImpl extends BaseFragmentViewImpl {
        void resUserFollowers(boolean y, String info, ArrayList<UserEntity> entities);
    }

    public interface WorkerImpl extends BaseFragmentWorkerImpl {
        void reqUserFollowers(String val);
    }

    public FragmentFollowersView(BaseFragment fragment, BaseFragmentViewImpl viewImpl, BaseFragmentWorkerImpl workerImpl, LayoutInflater inflater, ViewGroup container) {
