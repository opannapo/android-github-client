...
public class FragmentFollowing extends BaseFragment implements FragmentFollowingView.ViewImpl {
    private FragmentFollowingView view;
    private FragmentFollowingWorker worker;
    ...
    public void onViewCreatedBase(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = new FragmentFollowingView(this, this, worker, inflater, container);
        worker = new FragmentFollowingWorker(this);
    ...
    public void onHiddenChangedBase(boolean isHidden) {
        if (!isHidden && isFirstVisible()) {
            ...
            worker.reqUserFollowing(userEntity.getLogin());
        }
    }
    ...
    @Override
    public void resUserFollowing(boolean y, String info, ArrayList<UserEntity> entities) {
