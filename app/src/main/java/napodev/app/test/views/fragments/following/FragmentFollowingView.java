...
public class FragmentFollowingView extends BaseFragmentViewModel {
    @Child(R.id.rV) RecyclerView rV;

    public interface ViewImpl extends BaseFragmentViewImpl {
        void resUserFollowing(boolean y, String info, ArrayList<UserEntity> entities);
    }

    public interface WorkerImpl extends BaseFragmentWorkerImpl {
        void reqUserFollowing(String val);
    }

    public FragmentFollowingView(BaseFragment fragment, BaseFragmentViewImpl viewImpl, BaseFragmentWorkerImpl workerImpl, LayoutInflater inflater, ViewGroup container) {
