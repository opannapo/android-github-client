...
public class FragmentRepositoriesView extends BaseFragmentViewModel {
    @Child(R.id.rV) RecyclerView rV;

    public interface ViewImpl extends BaseFragmentViewImpl {
        void resUserRepositories(boolean y, String info, ArrayList<RepositoryEntity> entities);
    }

    public interface WorkerImpl extends BaseFragmentWorkerImpl {
        void reqUserRepositories(String val);
    }

    public FragmentRepositoriesView(BaseFragment fragment, BaseFragmentViewImpl viewImpl, BaseFragmentWorkerImpl workerImpl, LayoutInflater inflater, ViewGroup container) {
